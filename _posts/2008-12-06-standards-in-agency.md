...
[^3]:교육을 지속적으로 진행했지만, *웹 표준이나 웹 접근성을 모두 함께 준비해야한다는 공감대가 형성되지 않으면 그 몫은 고스란히 웹 퍼블리셔에게 돌아온다.* 신현석님이 이야기 했던 [웹 퍼블리셔][1]의 개념에는 사이트 제작 업무의 전반에 개입하면서 효율이나 구조의 개선을 추구한다는 가치가 포함되어 있지만, 그런 형태로 일하기엔 현실이 녹록치 않다.

[^4]:Free Lancer는 전장에 투입되는 용병에서 나온 말로 알고 있다. 아직도 이 분야의 용병들은 목숨을 걸고 일하고 있고, 몇 번쯤... 일하다 죽을 것 같았던 경험이 있는바 이 단어가 나에게 붙는게 썩 내키지 않는다.

[^5]:고용-피고용 등의 계약관계에서도 사용자라는 말을 쓰곤 한다.

[^6]:이번에 [브라우저 업그레이드 캠페인](/savethedeveloper/)을 진행하는 중에 어느 분께서도 하셨던 이야기지만, 진짜 문제는 브라우저 사용자가 아니라, 사람 사용자[^5]에 있다. 웹 에이전시에 국한된 이야기가 아니라 웹 에이전시에 의뢰하는 클라이언트, 나아가 웹 사이트를 운영하는 많은 기업들이 가진 시각의 문제이기도 하다. [월간 웹 기고 중](/web-serial-1st-korean-web/#title_index_50463223714915623418117323615715232236155185)에도 언급한 적이 있지만문제는 정부도 기업도, 제작자도 모두 안고 있다. 그 문제를 제대로 인식하고 개선하려는 노력을 하는 곳이 적은 것도 사실이다.

[^7]:장차법이 생기면서 웹 접근성이라는 분야에선 정말 좋은 설득의 근거가 생겼다. 다른 사람들 보다 먼저 웹 표준이나 웹 접근성을 시작한 사람들도 나름 정리하고 배려하려고 노력해 온 것도 사실이다. 눈에 잘 띄지 않거나 찾는 사람들 입맛에 안맞을 지라도 말이다.

[1]:http://zine.standardmag.org/200708/13/web-publisher-the-job
